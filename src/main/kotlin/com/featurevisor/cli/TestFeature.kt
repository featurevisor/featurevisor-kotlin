                         ...
                         if (variableSchema.type == VariableType.JSON) {
                             ...
                             val parsedExpectedValue = if (expectedValue is VariableValue.StringValue) {
                              ...
                              passed = when (actualValue) {
                                  is VariableValue.ArrayValue -> checkIfArraysAreEqual(stringToArray(parsedExpectedValue.toString()).orEmpty().toTypedArray(), actualValue.values.toTypedArray())
                                  is VariableValue.ObjectValue -> checkIfObjectsAreEqual((parsedExpectedValue as VariableValue.ObjectValue).value, (actualValue as VariableValue.ObjectValue).value)
                                  is VariableValue.JsonValue -> checkMapIsEquals((expectedValue as VariableValue.JsonValue).value, (actualValue as VariableValue.JsonValue).value)
                             ...
                             if (!passed) {
                                 ...
                                 val expectedValueString = if (expectedValue !is VariableValue.StringValue) expectedValue.toString() else expectedValue
                                 val actualValueString = if (actualValue !is VariableValue.StringValue) actualValue.toString() else actualValue
                             ...
                             passed = when (expectedValue) {
                                 is VariableValue.ArrayValue -> checkIfArraysAreEqual((expectedValue as VariableValue.ArrayValue).values.toTypedArray(), (actualValue as VariableValue.ArrayValue).values.toTypedArray())
